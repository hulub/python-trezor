...
_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_TestIn', index=57, number=70,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_TestOut', index=58, number=71,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\230\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_EosVote', index=59, number=72,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_EosVoteSignature', index=60, number=73,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\230\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_EosGetPublicKey', index=61, number=74,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_EosPublicKey', index=62, number=75,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\230\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkMemoryRead', index=68, number=110,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\240\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkMemory', index=69, number=111,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\250\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkMemoryWrite', index=70, number=112,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\240\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkFlashErase', index=71, number=113,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\240\265\030\001')),
      type=None),
  ],
...
MessageType_TestIn = 70
MessageType_TestOut = 71
MessageType_EosVote = 72
MessageType_EosVoteSignature = 73
MessageType_EosGetPublicKey = 74
MessageType_EosPublicKey = 75
...
_TESTIN = _descriptor.Descriptor(
  name='TestIn',
  full_name='TestIn',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='TestIn.message', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='number', full_name='TestIn.number', index=1,
...
_TESTOUT = _descriptor.Descriptor(
  name='TestOut',
  full_name='TestOut',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='TestOut.message', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EOSVOTE = _descriptor.Descriptor(
  name='EosVote',
  full_name='EosVote',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='L', full_name='EosVote.L', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='candidates', full_name='EosVote.candidates', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Y', full_name='EosVote.Y', index=2,
...
_EOSVOTESIGNATURE = _descriptor.Descriptor(
  name='EosVoteSignature',
  full_name='EosVoteSignature',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='c1', full_name='EosVoteSignature.c1', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='s', full_name='EosVoteSignature.s', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='color_enc', full_name='EosVoteSignature.color_enc', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='eID_enc', full_name='EosVoteSignature.eID_enc', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vote_enc', full_name='EosVoteSignature.vote_enc', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='PK_correct_enc', full_name='EosVoteSignature.PK_correct_enc', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='PK_vote', full_name='EosVoteSignature.PK_vote', index=6,
...
_EOSPUBLICKEY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='PublicKey', full_name='EosPublicKey.PublicKey', index=0,
      number=1, type=12, cpp_type=9, label=2,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EOSVOTESIGNATURE.fields_by_name['color_enc'].message_type = types__pb2._ELGAMALTUPLETYPE
_EOSVOTESIGNATURE.fields_by_name['eID_enc'].message_type = types__pb2._ELGAMALTUPLETYPE
_EOSVOTESIGNATURE.fields_by_name['vote_enc'].message_type = types__pb2._ELGAMALTUPLETYPE
_EOSVOTESIGNATURE.fields_by_name['PK_correct_enc'].message_type = types__pb2._DISCRETELOGARITHMEQUALITYPKTYPE
_EOSVOTESIGNATURE.fields_by_name['PK_vote'].message_type = types__pb2._DISCRETELOGARITHMPKTYPE
...
DESCRIPTOR.message_types_by_name['TestIn'] = _TESTIN
DESCRIPTOR.message_types_by_name['TestOut'] = _TESTOUT
DESCRIPTOR.message_types_by_name['EosVote'] = _EOSVOTE
DESCRIPTOR.message_types_by_name['EosVoteSignature'] = _EOSVOTESIGNATURE
...
TestIn = _reflection.GeneratedProtocolMessageType('TestIn', (_message.Message,), dict(
  DESCRIPTOR = _TESTIN,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:TestIn)
  ))
_sym_db.RegisterMessage(TestIn)

TestOut = _reflection.GeneratedProtocolMessageType('TestOut', (_message.Message,), dict(
  DESCRIPTOR = _TESTOUT,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:TestOut)
  ))
_sym_db.RegisterMessage(TestOut)

EosVote = _reflection.GeneratedProtocolMessageType('EosVote', (_message.Message,), dict(
  DESCRIPTOR = _EOSVOTE,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:EosVote)
  ))
_sym_db.RegisterMessage(EosVote)

EosVoteSignature = _reflection.GeneratedProtocolMessageType('EosVoteSignature', (_message.Message,), dict(
  DESCRIPTOR = _EOSVOTESIGNATURE,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:EosVoteSignature)
  ))
_sym_db.RegisterMessage(EosVoteSignature)
...
_MESSAGETYPE.values_by_name["MessageType_TestIn"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_TestIn"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001'))
_MESSAGETYPE.values_by_name["MessageType_TestOut"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_TestOut"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\230\265\030\001'))
_MESSAGETYPE.values_by_name["MessageType_EosVote"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_EosVote"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001'))
_MESSAGETYPE.values_by_name["MessageType_EosVoteSignature"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_EosVoteSignature"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\230\265\030\001'))
